...
shared_requires = ("openssl/3.3.7", "libcurl/8.18.0", "civetweb/1.16", "libxml2/2.15.2", "fmt/12.1.0", "spdlog/1.17.0", "catch2/3.9.1", "zlib/1.3.1", "zstd/1.5.2", "bzip2/1.0.8", "rocksdb/10.5.1")
